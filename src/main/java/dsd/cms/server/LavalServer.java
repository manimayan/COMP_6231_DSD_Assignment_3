...
public class LavalServer implements DCMSInterface {
	...
	public void serverConnection(int port, LavalServer lavalServerArg) {
		...
		Endpoint lavalServerEndPoint = Endpoint.publish(Constants.LVL_ENDPOINT_URL, lavalServer);
		System.out.println("Laval Server started : " + lavalServerEndPoint.isPublished());

		System.out.println("Laval server is loaded with initial data. Map size : " + teacherStudentRecords.size());
	...
	public String transferRecord(String userName, String recordID, String serverName) throws IOException {
		String recordFound =  this.mainServer.findAndRemoveRecordInmap(recordID, LogWriter.LAVAL, this.teacherStudentRecords);
