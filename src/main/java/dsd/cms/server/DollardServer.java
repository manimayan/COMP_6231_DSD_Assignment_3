...
public class DollardServer implements DCMSInterface {
	 ...
	 *                         performed
	 * @param dollardServerArg the dollard server arg
	 */
	public void serverConnection(int port, DollardServer dollardServerArg) {

		DollardServer dollardServer = dollardServerArg;
		Endpoint dollardServerEndPoint = Endpoint.publish(Constants.DDO_ENDPOINT_URL, dollardServer);
		System.out.println("Dollard Server started : " + dollardServerEndPoint.isPublished());
	...
	public String transferRecord(String userName, String recordID, String serverName) throws IOException {
		String recordFound = this.mainServer.findAndRemoveRecordInmap(recordID, LogWriter.DOLLARD,
				this.teacherStudentRecords);
